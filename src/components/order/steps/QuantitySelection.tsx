      ...
      <div className="glass-card rounded-2xl p-6 mb-8">
        <div className="space-y-3 text-right">
          <div className="flex justify-between items-center">
            <span className="text-white">{state.selectedProduct?.price.toFixed(2)} دينار ليبي</span>
            <span className="text-[var(--text-light)]">سعر القطعة</span>
          </div>
          {state.selectedDesign && state.selectedDesign.price > 0 && (
            <div className="flex justify-between items-center">
              <span className="text-white">{state.selectedDesign.price.toFixed(2)} دينار ليبي</span>
          ...
          <div className="flex justify-between items-center text-lg font-bold">
            <span className="text-[var(--accent-color)]">{getTotalPrice().toFixed(2)} دينار ليبي</span>
