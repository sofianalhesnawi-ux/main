...
const SnapchatIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
    ...
    <path d="M12 6.5c-1.8 0-3.2 1.4-3.2 3.1 0 1.1.5 2.1 1.3 2.7-.1.1-.1.2-.2.3-.4.6-.8 1.3-1.5 1.3-.2 0-.4 0-.5-.1-.3-.1-.7-.3-1.1-.3-.6 0-1.1.5-1.1 1.1s.5 1.1 1.1 1.1c.4 0 .8-.2 1.1-.3.2-.1.3-.1.5-.1.7 0 1.1.7 1.5 1.3.1.1.1.2.2.3-.8.6-1.3 1.6-1.3 2.7 0 1.7 1.4 3.1 3.2 3.1s3.2-1.4 3.2-3.1c0-1.1-.5-2.1-1.3-2.7.1-.1.1-.2.2-.3.4-.6.8-1.3 1.5-1.3.2 0 .4 0 .5.1.3.1.7.3 1.1.3.6 0 1.1-.5 1.1-1.1s-.5-1.1-1.1-1.1c-.4 0-.8.2-1.1.3-.2.1-.3.1-.5.1-.7 0-1.1-.7-1.5-1.3-.1-.1-.1-.2-.2-.3.8-.6 1.3-1.6 1.3-2.7 0-1.7-1.4-3.1-3.2-3.1z" fill="white" stroke="#000" strokeWidth="0.5"/>
  </svg>
);
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center pt-6 border-t border-white/10 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          <p className="text-[var(--text-light)] text-sm hover:text-white transition-colors duration-300">
            &copy; 2025 ليبيرو. جميع الحقوق محفوظة.
          </p>
        </div>
      </div>
    </footer>
